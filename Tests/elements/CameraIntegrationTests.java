...
public class CameraIntegrationTests {
    ...
    void constructRayThroughPixelWithSphere()
    {
        ...
        for (int i = 0; i < 3; ++i) {
            for (int j = 0; j < 3; ++j) {
                results = sph.findIntersections(cam1.constructRayThroughPixel(Nx, Ny, j, i));
                if (results != null)
                    count += results.size();
            }
        }
        ...
        for (int i = 0; i < 3; ++i) {
            for (int j = 0; j < 3; ++j) {
                results = sph2.findIntersections(cam2.constructRayThroughPixel(Nx, Ny, j, i));
                if (results != null)
                    count += results.size();
            }
        }
        ...
        for (int i = 0; i < 3; ++i)
        {
            for (int j = 0; j < 3; ++j)
            {
                results = sph3.findIntersections(cam2.constructRayThroughPixel(Nx, Ny, j, i));
                if (results != null)
                    count += results.size();
            }
        }
        ...
        for ( int i=0;i<3 ; ++i)
            for(int j = 0;j<3 ;++j)  {
                results = sph4.findIntersections(cam2.constructRayThroughPixel(Nx, Ny, j, i));
                if (results != null)
                    count += results.size();
            }
        ...
        for ( int i=0;i<3 ; ++i)
            for(int j = 0;j<3 ;++j)  {
                results = sph5.findIntersections(cam1.constructRayThroughPixel(Nx, Ny, j, i));
                if (results != null)
                    count += results.size();
            }
    ...
    {
        Camera cam = new Camera (Point3D.PointZERO, new Vector (0,0,1), new Vector (0,-1,0));
        List<Point3D> results;
        int count;
        ...
        for ( int i=0;i<3 ; ++i)
            for(int j = 0;j<3 ;++j)  {
                results = plane1.findIntersections(cam.constructRayThroughPixel(3, 3, j, i));
                if (results != null)
                    count += results.size();
            }
        assertEquals(9,count,"wrong amount of intersections");
        ...
        for ( int i=0;i<3 ; ++i)
            for(int j = 0;j<3 ;++j)  {
                results = plane2.findIntersections(cam.constructRayThroughPixel(3, 3, j, i));
                if (results != null)
                    count += results.size();
            }
        assertEquals(9,count,"wrong amount of intersections");
        ...
        for ( int i=0;i<3 ; ++i)
            for(int j = 0;j<3 ;++j)  {
                results = plane3.findIntersections(cam.constructRayThroughPixel(3, 3, j, i));
                if (results != null)
                    count += results.size();
            }
        ...
        for ( int i=0;i<3 ; ++i)
            for(int j = 0;j<3 ;++j)  {
                results = plane4.findIntersections(cam.constructRayThroughPixel(3, 3, j, i));
                if (results != null)
                    count += results.size();
            }
        assertEquals(0,count,"wrong amount of intersections");
    ...
    public void constructRayThroughPixelWithTriangle()
    {
        ...
        for ( int i=0;i<3 ; ++i)
            for(int j = 0;j<3 ;++j)  {
                results = tr1.findIntersections(cam.constructRayThroughPixel(3, 3, j, i));
                if (results != null)
                    count += results.size();
            }
        ...
        for ( int i=0;i<3 ; ++i)
            for(int j = 0;j<3 ;++j)  {
                results = tr2.findIntersections(cam.constructRayThroughPixel(3, 3, j, i));
                if (results != null)
                    count += results.size();
            }
